<x-header />
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                @foreach($products->groupBy('type') as $type => $typeProducts)

                <ul class="filter__controls">
                    <li class="active" data-filter="*">{{ $type }}</li>
                </ul>
                </div>
            </div>
                            ...
                            <div class="product__item sale">
                                ...
                                <div class="product__item__text">
                                    ...
                                    <div class="rating">
                                        ...
                                        <i class="fa <section class="shop spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6>Piqué Biker Jacket</h6>
                                    <a href="{{url('Shopping')}}" class="add-cart">+ Add To Cart</a>
                                    <div class="rating">
                                        <i class="fa fa-star-o"></i>
                                        <i class="fa fa-star-o"></i>
                                        <i class="fa fa-star-o"></i>
